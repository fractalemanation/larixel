...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-3">
			<div class="jumbotron">
				<p><span class="label label-primary">Новости {{$count_articles}}</span></p>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="jumbotron">
	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			<a class="list-group-item" href="{{route('admin.article.edit', $article)}}">
				...
				<p class="list-group-item-text">{{$article->categories()->pluck('title')->implode(', ')}}</p><!--pluck возвращает наименование ключа-->
			</a>
			@endforeach
		</div>
</div>
